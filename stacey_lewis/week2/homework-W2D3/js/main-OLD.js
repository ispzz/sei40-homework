...
const catTrumbone = document.querySelector('#cat-trumbone');
catTrumbone.style.position='absolute';
catTrumbone.style.right = '10px';
// catTrumbone.style.width = '100px';
catTrumbone.style.bottom = '0px';

const hiCat = document.querySelector('#hi-cat');
hiCat.style.position='absolute';
hiCat.style.right = '0px';
// hiCat.style.width = '100px';
hiCat.style.top = '0px';

const hiCatLeft = document.querySelector('#hi-cat-left');
hiCatLeft.style.position='absolute';
hiCatLeft.style.left = '0px';
// hiCat.style.width = '100px';
hiCatLeft.style.top = '0px';
hiCatLeft.style.transform = "rotateY(180deg)";

const mouse = document.querySelector('#mouse');
mouse .style.position='absolute';
mouse.style.right = '600px';
mouse.style.width = '400px';
mouse.style.bottom = '200px';
