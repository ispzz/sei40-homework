...
// debugger;
    ...
    // console.log('randomFirstNum:', randomFirstNum);

    const randomFirstIndex = Math.floor( randomFirstNum );
    // console.log('randomFirstIndex:', randomFirstIndex);

    const adjectiveOne = firstAdjectives [randomFirstIndex] ;
    console.log('adjectiveOne:', adjectiveOne);


    const randomSecondNum = Math.random() * firstAdjectives.length;
    // console.log('randomSecondNum:', randomFirstNum);

    const randomSecondIndex = Math.floor( randomFirstNum );
    // console.log('randomSecondIndex:', randomFirstIndex);

    const adjectiveTwo = secondAdjectives [randomFirstIndex] ;
