...
//2. check each letter against the user's current guessed

// const fakeGuessLetter = 'X'; //for testing
...
const guessLetter = function ( userGuess ){
  ...
  for ( let i = 0; i < secretWord.length; i++) {
    ...
    if ( userGuess === secretLetter ){
      ...
      //Update the guessLetters array to show the correct guess:
      guessedLetters [i] = secretLetter;
      matchFound = true;
        }
      // console.log( secretLetter );
    } //for
      //now it's safe tp check if a match was found for any letters:
